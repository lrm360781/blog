            ...
            <div class="visit">
                <% if (theme.visit_counter.site_visit) { %>
                    <span style='display:inline'>
                        <span id="site-visit" title="<%= __('visit_counter.site') %>"><i class="fa fa-user" aria-hidden="true"></i>本站总访问量<span id="busuanzi_value_site_pv"></span>次
                        </span>
                    </span>
                <% } %>
                ...
                <% if (theme.visit_counter.page_visit) { %>
                    <span style='display:inline'>
                        <span id="page-visit"  title="<%= __('visit_counter.page') %>"><i class="fa fa-user" aria-hidden="true"></i>您是第<span id="busuanzi_value_site_uv"></span>位小伙伴
                        </span>
                    </span>
                <% } %>
            </div>
